		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#nsuploadsite-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"nsuploadsite-display": {
								"semanticObject": "nsuploadsite",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ns.uploadsite",
									"url": sap.ui.require.toUrl("ns/uploadsite")
								}
							}
						}
					}
