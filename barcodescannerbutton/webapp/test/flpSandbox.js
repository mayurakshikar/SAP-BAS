		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#nsbarcodescannerbutton-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"nsbarcodescannerbutton-display": {
								"semanticObject": "nsbarcodescannerbutton",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ns.barcodescannerbutton",
									"url": sap.ui.require.toUrl("ns/barcodescannerbutton")
								}
							}
						}
					}
