		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#nsuploadsitedata-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"nsuploadsitedata-display": {
								"semanticObject": "nsuploadsitedata",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ns.uploadsitedata",
									"url": sap.ui.require.toUrl("ns/uploadsitedata")
								}
							}
						}
					}
